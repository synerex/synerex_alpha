module github.com/synerex/synerex_alpha/provider/simulation/simutil/objects/provider
...
replace (
	...
	github.com/synerex/synerex_alpha/provider/simulation/simutil/objects/agent => ../../objects/agent
)
