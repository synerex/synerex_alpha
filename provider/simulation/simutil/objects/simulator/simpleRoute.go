...
func NewSimpleRoute(timeStep float64, globalTime float64, area *area.AreaInfo, agents []*agent.AgentInfo, agentType int64) *SimpleRoute {
	r := &SimpleRoute{
		TimeStep:   timeStep,
...
func (simple *SimpleRoute) IsAgentInControlledArea(agentInfo *agent.AgentInfo, areaInfo *area.AreaInfo, agentType int64) bool {
