module github.com/synerex/synerex_alpha/provider/simulation/rvo2util
...
replace (
	github.com/synerex/synerex_alpha/provider/simulation/rvo2util/rvo2-go/src/rvosimulator => ./rvo2-go/src/rvosimulator
