...
import (
	...
	rvo "github.com/synerex/synerex_alpha/provider/simulation/rvo2util/rvo2-go/src/rvosimulator"
)
...
func NewRVOSimulator() *RVOSimulator {
	r := &RVOSimulator{}
	return r
}
...
func main() {
	sim := rvo.NewRVOSimulator(1, 1.5, 5, 1.5, 2, 0.04, 0.01, &rvo.Vector2{X: 0, Y: 0})
	...
	for step := 0; step < 30; step++ {
		...
		ShowProgress(sim, nextAgents, step)
