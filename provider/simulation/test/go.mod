module github.com/synerex/synerex_alpha/provider/simulation/test
...
replace (
	github.com/synerex/synerex_alpha/provider/simulation/rvo2-go/src/rvosimulator => ../rvo2util/rvo2-go/src/rvosimulator
