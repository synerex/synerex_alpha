...
// source: api/fleet/fleet.proto

package fleet // import "api/fleet"
...
func (*FleetService) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_8c194cafd7ac9678, []int{0}
}
...
func (*FleetService_ShareRideSerivce) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_8c194cafd7ac9678, []int{0, 0}
}
...
func (*FleetService_DeliverSerivce) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_8c194cafd7ac9678, []int{0, 1}
}
...
func (*Fleet) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_8c194cafd7ac9678, []int{1}
}
...
func (*Fleet_Coord) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_8c194cafd7ac9678, []int{1, 0}
}
...
func init() { proto.RegisterFile("api/fleet/fleet.proto", fileDescriptor_fleet_8c194cafd7ac9678) }

var fileDescriptor_fleet_8c194cafd7ac9678 = []byte{
	// 473 bytes of a gzipped FileDescriptorProto
	,
}
