...
func (*FleetService) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_c87332fc64513232, []int{0}
}
...
func (*FleetService_ShareRideSerivce) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_c87332fc64513232, []int{0, 0}
}
...
func (*FleetService_DeliverSerivce) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_c87332fc64513232, []int{0, 1}
}
...
func (*Fleet) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_c87332fc64513232, []int{1}
}
...
func (*Fleet_Coord) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_c87332fc64513232, []int{1, 0}
}
...
func init() { proto.RegisterFile("fleet/fleet.proto", fileDescriptor_fleet_c87332fc64513232) }

var fileDescriptor_fleet_c87332fc64513232 = []byte{
	// 472 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x74, 0x93, 0xe1, 0x6e, 0xd3, 0x30,
	0x10, 0xc7, 0x69, 0x33, 0x6f, 0xcd, 0x75, 0x94, 0x61, 0xa1, 0x11, 0x55, 0x42, 0x44, 0x93, 0x80,
	...
	,
}
