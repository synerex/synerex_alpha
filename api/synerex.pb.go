...
import agent "github.com/synerex/synerex_alpha/api/simulation/agent"
import area "github.com/synerex/synerex_alpha/api/simulation/area"
import clock "github.com/synerex/synerex_alpha/api/simulation/clock"
...
func (ChannelType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_synerex_57b9974130e40977, []int{0}
}
...
func (*ConfirmResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_synerex_57b9974130e40977, []int{1}
}
...
func (*Supply) Descriptor() ([]byte, []int) {
	return fileDescriptor_synerex_57b9974130e40977, []int{2}
}
...
func _Supply_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Supply_Arg_ClockService:
		b.EncodeVarint(18<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Arg_ClockService); err != nil {
			return err
		}
	case *Supply_Arg_AreaService:
		b.EncodeVarint(19<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Arg_AreaService); err != nil {
			return err
		}
	case *Supply_Arg_AgentService:
		b.EncodeVarint(20<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Arg_AgentService); err != nil {
			return err
		}
	case nil:
	default:
...
func _Supply_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 17: // arg_oneof.arg_PTgtfs
		...
		return true, err
	case 18: // arg_oneof.arg_ClockService
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(clock.ClockService)
		err := b.DecodeMessage(msg)
		m.ArgOneof = &Supply_Arg_ClockService{msg}
		return true, err
	case 19: // arg_oneof.arg_AreaService
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(area.AreaService)
		err := b.DecodeMessage(msg)
		m.ArgOneof = &Supply_Arg_AreaService{msg}
		return true, err
	case 20: // arg_oneof.arg_AgentService
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(agent.AgentService)
		err := b.DecodeMessage(msg)
		m.ArgOneof = &Supply_Arg_AgentService{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Supply_OneofSizer(msg proto.Message) (n int) {
	...
	case *Supply_Arg_PTgtfs:
		...
		n += s
	case *Supply_Arg_ClockService:
		s := proto.Size(x.Arg_ClockService)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Supply_Arg_AreaService:
		s := proto.Size(x.Arg_AreaService)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Supply_Arg_AgentService:
		s := proto.Size(x.Arg_AgentService)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*Demand) Descriptor() ([]byte, []int) {
	return fileDescriptor_synerex_57b9974130e40977, []int{3}
}
...
func _Demand_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Demand_Arg_ClockService:
		b.EncodeVarint(18<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Arg_ClockService); err != nil {
			return err
		}
	case *Demand_Arg_AreaService:
		b.EncodeVarint(19<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Arg_AreaService); err != nil {
			return err
		}
	case *Demand_Arg_AgentService:
		b.EncodeVarint(20<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Arg_AgentService); err != nil {
			return err
		}
...
func _Demand_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 18: // arg_oneof.arg_ClockService
		...
		msg := new(clock.ClockService)
		err := b.DecodeMessage(msg)
		m.ArgOneof = &Demand_Arg_ClockService{msg}
		return true, err
	case 19: // arg_oneof.arg_AreaService
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(area.AreaService)
		err := b.DecodeMessage(msg)
		m.ArgOneof = &Demand_Arg_AreaService{msg}
		return true, err
	case 20: // arg_oneof.arg_AgentService
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(agent.AgentService)
		err := b.DecodeMessage(msg)
		m.ArgOneof = &Demand_Arg_AgentService{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*Target) Descriptor() ([]byte, []int) {
	return fileDescriptor_synerex_57b9974130e40977, []int{4}
}
...
func (*Channel) Descriptor() ([]byte, []int) {
	return fileDescriptor_synerex_57b9974130e40977, []int{5}
}
...
func (*Mbus) Descriptor() ([]byte, []int) {
	return fileDescriptor_synerex_57b9974130e40977, []int{6}
}
...
func (*MbusMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_synerex_57b9974130e40977, []int{7}
}
...
func init() { proto.RegisterFile("synerex.proto", fileDescriptor_synerex_57b9974130e40977) }

var fileDescriptor_synerex_57b9974130e40977 = []byte{
	...
	,
}
