...
const (
	...
	ChannelType_END                 ChannelType = 11
)
...
type Supply_Arg_ParticipantInfo struct {
	Arg_ParticipantInfo *participant.ParticipantInfo `protobuf:"bytes,25,opt,name=arg_ParticipantInfo,json=argParticipantInfo,proto3,oneof"`
}
...
func (*Supply_Arg_ParticipantInfo) isSupply_ArgOneof() {}
...
func (m *Supply) GetArg_ParticipantInfo() *participant.ParticipantInfo {
	if x, ok := m.GetArgOneof().(*Supply_Arg_ParticipantInfo); ok {
		return x.Arg_ParticipantInfo
	}
	return nil
}
...
func (*Supply) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Supply_Arg_ParticipantInfo)(nil),
	}
}
...
type Demand struct {
	...
	//	*Demand_Arg_AgentsDemand
	//	*Demand_Arg_ParticipantDemand
...
type Demand_Arg_AgentsDemand struct {
	Arg_AgentsDemand *agent.AgentsDemand `protobuf:"bytes,25,opt,name=arg_AgentsDemand,json=argAgentsDemand,proto3,oneof"`
}

type Demand_Arg_ParticipantDemand struct {
	Arg_ParticipantDemand *participant.ParticipantDemand `protobuf:"bytes,26,opt,name=arg_ParticipantDemand,json=argParticipantDemand,proto3,oneof"`
}
...
func (*Demand_Arg_AgentsDemand) isDemand_ArgOneof() {}

func (*Demand_Arg_ParticipantDemand) isDemand_ArgOneof() {}
...
func (m *Demand) GetArg_AgentsDemand() *agent.AgentsDemand {
	if x, ok := m.GetArgOneof().(*Demand_Arg_AgentsDemand); ok {
		return x.Arg_AgentsDemand
	}
	return nil
}

func (m *Demand) GetArg_ParticipantDemand() *participant.ParticipantDemand {
	if x, ok := m.GetArgOneof().(*Demand_Arg_ParticipantDemand); ok {
		return x.Arg_ParticipantDemand
	}
	return nil
}
...
func (*Demand) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Demand_Arg_AgentsDemand)(nil),
		(*Demand_Arg_ParticipantDemand)(nil),
	}
}
...
var fileDescriptor_64312b9648bb40d3 = []byte{
	...
	,
}
