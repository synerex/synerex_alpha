                ...
                <section className="sidebar">
                    ...
                    */}
                    ...
                    <ul className="sidebar-menu" data-widget="tree">
                        ...
                        <li>
                            <a href="#" onClick={()=>{this.props.viewChange()}}>
                                <i className="fa fa-th"></i> <span>3D View</span>
                                <span className="pull-right-container">
                            </span>
                            </a>
                        </li>
                        <li>
                            <a href="#" onClick={()=>{this.props.toggleTurn()}}>
                                <i className="fa fa-th"></i> <span>ToggleTurn</span>
                                <span className="pull-right-container">
                            </span>
                            </a>
                        </li>
                        <li>
                            <a href="#" onClick={()=>{this.props.clearLogs()}}>
                                <i className="fa fa-th"></i> <span>Clear</span>
                                <span className="pull-right-container">
                            </span>
                            </a>
                        </li>
                        <li>
                            <a href="#" onClick={()=>{this.props.addLog()}}>
                                <i className="fa fa-th"></i> <span>Add Node</span>
                                <span className="pull-right-container">
                            </span>
                            </a>
                        </li>
