...
require (
	...
	github.com/synerex/synerex_alpha/api/simulation/area v0.0.0-00010101000000-000000000000 // indirect
	github.com/synerex/synerex_alpha/api/simulation/clock v0.0.0-00010101000000-000000000000
	github.com/synerex/synerex_alpha/api/simulation/common v0.0.0-00010101000000-000000000000
	github.com/synerex/synerex_alpha/api/simulation/participant v0.0.0-00010101000000-000000000000 // indirect
